    ...
    <el-main>
      <el-row>
        <el-card style="padding: 15px">
          <!--题目信息-->
          <div>
            <span v-if="currentBankQuestion[curIndex].questionType === 1">【Single choice】</span>
            <span v-else-if="currentBankQuestion[curIndex].questionType === 2">【Multiple choice】</span>
            <span v-else>【True or false】</span>
          ...
          <div
            ...
            <span style="color: #1f90ff" v-text="'Right answer：' + optionName[trueAnswerIndex]"></span>
          </div>
          ...
          <div
            ...
            <span style="color: #1f90ff" v-text="'Right answer：' +  multipleAnswer"></span>
          </div>

          <div style="margin-top: 25px">
            <el-button type="primary" :disabled="curIndex<1" @click="curIndex--">Previous</el-button>
            <el-button type="primary" :disabled="curIndex>=currentBankQuestion.length-1" @click="curIndex++">Next
            </el-button>
          </div>
      ...
      <el-row>
        <el-card style="position:relative;height: 60px;margin-top: 25px;">
          ...
          <span
            ...
            Accuracy rate: {{ (trueSum + wrongSum) !== 0 ? ((trueSum / (wrongSum + trueSum)) * 100).toFixed(0) + '%' : '0%' }}
          </span>
        </el-card>
      </el-row>
...
export default {
  ...
  created () {
    //一创建就改变头部的面包屑
    this.$emit('giveChildChangeBreakInfo', 'Start training', 'Online exam')
