<template>
  <el-container>
    <el-header>
      <el-input v-model="queryInfo.bankName" @blur="contentChange" placeholder="bankName"
                style="width: 220px"
                prefix-icon="el-icon-search"></el-input>
      <br>
      <el-button type="primary" style="margin-top: 10px" icon="el-icon-plus" @click="addTableVisible = true">Add
      </el-button>
    ...
    <el-main style="margin-top: 20px">
      ...
      <el-table
        ...
        <el-table-column align="center"
                         prop="singleChoice"
                         label="Number of Single choice">
        </el-table-column>

        <el-table-column align="center"
                         prop="multipleChoice"
                         label="Number of Multiple choice">
        </el-table-column>

        <el-table-column align="center"
                         prop="judge"
                         label="Number of Judgment questions">
        </el-table-column>
      ...
      <!--添加题库信息-->
      <el-dialog title="Add Question Bank" :visible.sync="addTableVisible" width="30%" @close="$refs['addForm'].resetFields()"
                 center>

        <el-form :model="addForm" :rules="addFormRules" ref="addForm">

          <el-form-item label="Question bank name" label-width="200px" prop="bankName">
        ...
        <div slot="footer" class="dialog-footer">
          <el-button @click="addTableVisible = false">Cancel</el-button>
          <el-button type="primary" @click="addQuestionBank">Confirm</el-button>
        </div>
      </el-dialog>
